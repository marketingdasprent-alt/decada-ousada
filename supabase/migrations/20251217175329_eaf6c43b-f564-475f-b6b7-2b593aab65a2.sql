-- 1. Atualizar a função gerar_contrato_atomico com versionamento
...
-- 2. Limpar contratos duplicados existentes - marcar antigos como substituídos
...
-- 3. Atualizar versões corretamente para todos os contratos
WITH versioned AS (
  SELECT id,
         ROW_NUMBER() OVER (
           PARTITION BY motorista_id, empresa_id 
