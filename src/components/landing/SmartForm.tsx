...
export const SmartForm = ({ initialType = null, onClose }: SmartFormProps) => {
  ...
  const situacoesSlot = [
    {
      value: 'licenca_e_viatura',
      label: 'Tenho licença TVDE e viatura própria',
      icon: '✅',
      canSubmit: true,
    },
    {
      value: 'viatura_em_formacao',
      label: 'Tenho viatura mas estou em formação TVDE',
      icon: '⏳',
      canSubmit: true,
    },
    {
      value: 'viatura_sem_licenca',
      label: 'Tenho viatura mas não tenho licença TVDE',
      icon: '❌',
      canSubmit: false,
    },
  ];
  ...
  const handleSituacaoChange = (value: string) => {
    ...
    if (selected && !selected.canSubmit) {
      ...
      toast({
        ...
        description:
          'Para trabalhar como motorista TVDE é obrigatório possuir licença. Procure um centro de formação certificado.',
        variant: 'destructive',
        duration: 8000,
      });
    } else {
            ...
            >
              ...
              <div>
                ...
                <p className="text-[#E53333]/70 text-sm mt-1">
                  Para trabalhar como motorista TVDE é necessário possuir licença. Procure um centro
                  de formação certificado na sua zona.
                </p>
              </div>
            </motion.div>
          )}
