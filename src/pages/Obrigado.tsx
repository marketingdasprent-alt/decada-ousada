    ...
    <div className="min-h-screen" style={{ backgroundColor: '#000000' }}>
      <div className="min-h-screen flex items-center justify-center px-4">
        ...
        >
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6">Obrigado!</h1>
          ...
          <div className="space-y-4">
            <p className="text-yellow-500 font-medium text-lg">⚡ Seja bem-vindo à nossa equipa!</p>
