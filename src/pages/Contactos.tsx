        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Fala <span className="text-[#E53333]">Connosco</span>
            </h1>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-[#E53333] font-semibold">+351 912 023 234</p>
            </motion.a>
            ...
            >
              <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-[#B20101]/20 flex items-center justify-center group-hover:bg-[#B20101]/30 transition-colors">
                <Phone className="w-8 h-8 text-[#E53333]" />
              </div>
              <h3 className="text-xl font-semibold mb-2">Telefone</h3>
              <p className="text-gray-400 mb-4">Linha direta</p>
              <p className="text-[#E53333] font-semibold">309 100 174</p>
            </motion.a>
            ...
            >
              ...
              <p className="text-[#E53333] font-semibold text-sm">motoristas.tvde@distanciaarrojada.pt</p>
            </motion.a>
          </div>
        </div>
      </section>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full bg-[#B20101]/20 flex items-center justify-center flex-shrink-0">
                    <Clock className="w-5 h-5 text-[#E53333]" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full bg-[#B20101]/20 flex items-center justify-center flex-shrink-0">
                    <MapPin className="w-5 h-5 text-[#E53333]" />
                  </div>
                  <div>
