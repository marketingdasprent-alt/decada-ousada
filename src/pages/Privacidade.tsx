            ...
            >
              <div className="bg-gray-800/30 rounded-xl p-6">
                ...
                <p className="text-gray-400">
                  ...
                  pessoais recolhidos através deste website e dos serviços prestados. Para questões
                  relacionadas com privacidade, contacte-nos através do email{' '}
                  <a
              ...
              <div className="bg-gray-800/30 rounded-xl p-6">
                ...
                <ul className="text-gray-400 space-y-2 list-disc list-inside">
                  <li>
                    <strong className="text-white">Dados de identificação:</strong> nome, NIF,
                    documento de identificação
                  </li>
                  <li>
                    <strong className="text-white">Dados de contacto:</strong> email, telefone,
                    morada
                  </li>
                  <li>
                    <strong className="text-white">Dados profissionais:</strong> carta de condução,
                    certificado TVDE
                  </li>
                  <li>
                    <strong className="text-white">Dados de navegação:</strong> endereço IP,
                    cookies, dados de utilização do website
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-gray-800/30 rounded-xl p-6">
                ...
                <p className="text-gray-400">
                  O tratamento de dados pessoais baseia-se na execução de contrato, cumprimento de
                  obrigações legais, consentimento do titular (quando aplicável) e interesses
                  legítimos da empresa para melhoria dos serviços.
                </p>
              </div>
              ...
              <div className="bg-gray-800/30 rounded-xl p-6">
                ...
                <p className="text-gray-400">
                  Os dados pessoais podem ser partilhados com entidades terceiras para cumprimento
                  de obrigações legais, seguradoras (no âmbito dos seguros de veículos), e
                  prestadores de serviços que atuem em nosso nome, sempre com garantias adequadas de
                  proteção de dados.
                </p>
              </div>
              ...
              <div className="bg-gray-800/30 rounded-xl p-6">
                ...
                <p className="text-gray-400">
                  ...
                  que motivaram a sua recolha, cumprimento de obrigações legais e durante os prazos
              ...
              <div className="bg-gray-800/30 rounded-xl p-6">
                ...
                <p className="text-gray-400 mb-4">Nos termos do RGPD, tem os seguintes direitos:</p>
                <ul className="text-gray-400 space-y-2 list-disc list-inside">
              ...
              <div className="bg-gray-800/30 rounded-xl p-6">
                ...
                <p className="text-gray-400">
                  ...
                  pessoais contra acesso não autorizado, alteração, divulgação ou destruição. Os
                  nossos sistemas são regularmente monitorizados e atualizados para garantir a
                  segurança dos dados.
                </p>
              </div>
              ...
              <div id="cookies" className="bg-gray-800/30 rounded-xl p-6 scroll-mt-24">
                ...
                <p className="text-gray-400 mb-4">
                  O nosso website utiliza cookies para melhorar a experiência de navegação. Os
                ...
                <ul className="text-gray-400 space-y-2 list-disc list-inside mb-4">
                  <li>
                    <strong className="text-white">Cookies essenciais:</strong> Necessários para o
                    funcionamento do website
                  </li>
                  <li>
                    <strong className="text-white">Cookies de desempenho:</strong> Ajudam-nos a
                    entender como os visitantes utilizam o website
                  </li>
                  <li>
                    <strong className="text-white">Cookies de funcionalidade:</strong> Permitem
                    funcionalidades melhoradas e personalização
                  </li>
                  <li>
                    <strong className="text-white">Cookies de marketing:</strong> Utilizados para
                    apresentar anúncios relevantes
                  </li>
                </ul>
                ...
                <p className="text-gray-400">
                  ...
                  navegador. Note que a desativação de alguns cookies pode afetar a funcionalidade
                  do website.
                </p>
              </div>
              ...
              <div className="bg-gray-800/30 rounded-xl p-6">
                ...
                <p className="text-gray-400">
                  ...
                  momento. As alterações serão publicadas nesta página com a respetiva data de
                  atualização. Recomendamos a consulta regular desta página.
                </p>
              </div>
              ...
              <div className="bg-gray-800/30 rounded-xl p-6">
                ...
                <p className="text-gray-400">
                  Para exercer os seus direitos ou esclarecer questões sobre privacidade,
